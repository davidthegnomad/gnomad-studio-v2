    ...
    <header className="sticky top-0 z-[60] w-full bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-primary/10">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-10">
          <a className="text-sm font-medium hover:text-primary transition-colors" href={getLink("#story")}>Our Story</a>
          <a className="text-sm font-medium hover:text-primary transition-colors" href={getLink("#how-it-works")}>How it Works</a>
          <a className="text-sm font-medium hover:text-primary transition-colors" href={getLink("#options")}>Ownership</a>
          <Link className="text-sm font-medium hover:text-primary transition-colors" to="/shop">Shop Shares</Link>
          {user && (
      ...
      `}>
        <nav className="flex flex-col p-8 space-y-6">
          <a className="text-2xl font-bold border-b border-primary/10 pb-4" href={getLink("#story")} onClick={() => setIsMobileMenuOpen(false)}>Our Story</a>
          <a className="text-2xl font-bold border-b border-primary/10 pb-4" href={getLink("#how-it-works")} onClick={() => setIsMobileMenuOpen(false)}>How it Works</a>
          <a className="text-2xl font-bold border-b border-primary/10 pb-4" href={getLink("#options")} onClick={() => setIsMobileMenuOpen(false)}>Ownership Options</a>
          <Link className="text-2xl font-bold border-b border-primary/10 pb-4" to="/shop" onClick={() => setIsMobileMenuOpen(false)}>Shop Shares</Link>
