...
import BeefShareCard from '@/components/selector/BeefShareCard';
import Calculator from '@/components/selector/Calculator';
import { BEEF_SHARES } from '@/lib/beef-constants';

const SelectorPage: React.FC = () => {
    return (
        <div className="relative flex flex-col bg-background-light selection:bg-primary/20">
