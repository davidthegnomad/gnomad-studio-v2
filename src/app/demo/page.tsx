...
const demoSites = [
    ...
    { name: "McDaniel Chiropractic", href: "/DEMO/mcdaniel-chiropractic/index.html", category: "Health & Wellness" },
    ...
    { name: "Pisano's Pizza", href: "/DEMO/pisanos-pizza/index.html", category: "Restaurant" },
